...
def fetch_crux_history():
    ...
    for mset in metric_sets:
        try:
            body = {"origin": ORIGIN, "formFactor": "PHONE", "metrics": mset}
    ...
    # each collection period is a rolling 28-day window; lastDate month = the report month
    ...
    # forward-fill any missing datapoints so charts never break
...
def main():
    ...
    print("Latest CrUX month:", new_month, "| points:", len(months))
    ...
    # homepage monthly scores (page table + score trend)
